                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                @if(count($receiveStockOrder->stock_order_receive_documents)>0)
                                                    @foreach ($receiveStockOrder->stock_order_receive_documents as $key => $option) 

                                                        <div class="col-md-3 documents-upload mb-1" id="documents_{{ $option->id }}">

                                                            <div class="file-upload-box">
                                                                <h2>Download File</h2>
                                                                <a download href="{{asset($option->document_name)}}" class="btn btn-info text-center btn-sm">
                                                                    <i class="fa fa-download"></i> Download
                                                                </a>

                                                                {!! Form::hidden("documents[old][$option->id]", $option->document_name) !!}

                                                                <button type="button" class="btn btn-sm btn-danger deleteExp" onClick="removeOptionRow({{$option->id}}, 0)">
...
$('#optionBtn').on('click', function(){
    ...
    var exOptionContent = '<div class="col-md-3 documents-upload mb-1" id="documents_'+optionName+'">'+
                            '<div class="file-upload-box">'+
                                '<h2>Upload File</h2>'+
                                '<input type="file" name="documents[new]['+optionName+']" class="file-input" id="fileInput">'+
                                ...
                                '<button type="button" class="btn btn-sm btn-danger deleteExp" onClick="removeOptionRow('+optionName+', 0)"><i class="fa fa-trash"></i> Delete</button>'+
                            '</div>'+
                        '</div>';
    $('#optionBtn').before(exOptionContent);
});
